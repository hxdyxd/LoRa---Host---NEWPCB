...
typedef struct sLoraLowLevelFunc
{
 ...
 * Mult Lora support
 */
typedef struct sLora
{
    //int32_t HoppingFrequencies[53];
 ...
 */
    ...
    tSX1276LR *SX1276LR;  //uint8_t SX1276Regs[0x70];
/*!
 ...
 */
    uint8_t RFLRState;  //default: RFLR_STATE_IDLE
/*!
 * Rx management support variables
 */
    uint16_t RxPacketSize;  //default:0
    int8_t RxPacketSnrEstimate;
    double RxPacketRssiValue;
    uint8_t RxGain;  //default: 1
    uint32_t RxTimeoutTimer; //default:0
/*!
 ...
 */
    uint16_t TxPacketSize; //default:0;
/*!
 * Lora Low Level Function
 */
	tLoraLowLevelFunc LoraLowLevelFunc;
